...
Ejemplo:
$nEsimaAparicion(l=\langle 1,2,3,2,4,5,6,2,7,8,2,9,0 \rangle, e=2, n=3) = 7$

\begin{proc}{nEsimaAparicion}{\In l: \TLista{\float}, \In e: \float, \In n: \ent, \Out result: \ent}{}
    \pre{e \in l}
    \post{0 \leq result < |l| \yLuego l[result] = e \yLuego n = \sum_{i=0}^{i=result} \IfThenElse{s[i] = e}{1}{0}}
\end{proc}
